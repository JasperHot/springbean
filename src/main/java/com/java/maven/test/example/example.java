...
public class example {
	...
	public static void main(String[] args) {
		...
		System.out.println("aa[0]=" + aa.get(0).getAge() + " "
				+ aa.get(0).getAge().hashCode());
		System.out.println("aa[1]=" + aa.get(1).getAge() + " "
				+ aa.get(1).getAge().hashCode());
		System.out.println("bb[0]=" + bb.get(0).getAge() + " "
				+ bb.get(0).getAge().hashCode());
		System.out.println("bb[1]=" + bb.get(1).getAge() + " "
				+ bb.get(1).getAge().hashCode());
		System.out.println("aa[0]?=bb[1]:" + aa.get(0).equals(bb.get(1)));
		String aaa = new String("Zhangsan");
		String bbb = new String("Zhangsan");
		System.out.println("aaa?=bbb:" + aaa.equals(bbb) + " "
				+ (aaa.hashCode() == bbb.hashCode()) + " " + (aaa == bbb));
